...
| **4** | 全公司·行銷 | newsletter · marketing · marketing-content · posters · marketing-landing | marketing-shell + poster(6平台) | 待 |
| **5** | 全公司·供應商 | suppliers · supplier-enrichment · tour-monitor · competitor-monitor | marketing-shell(供應商) | 待 |
| **6** | 營運 | bookings/訂單 · departures-calendar · visa/簽證 · reviews · packpoint · vouchers | pages-ops(訂單/出團/簽證/客服/新客spam) | 待 |
| **7** | 行程管理頁 | tours/行程 | pages-tour(圖/地圖/itinerary/cost/calibration) | 待 |
| **8** | 冷門 power(乾淨黑白,非卡片) | analytics · affiliate · ai-hub · llm-cost · monitor · audit-log · calibration-review · autonomous-agents · skills · cleanup · task-history | (無 mockup) | 待 |
