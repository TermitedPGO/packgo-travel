...
// See server/db/booking.ts. This shim re-exports the 13 booking/payment CRUD
// helpers so existing `import { createBooking } from "../db"` call sites
// across ~40 routers + agents + services continue working unchanged.
