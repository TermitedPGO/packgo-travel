...
-- v3 的四個稽核欄(lastSeenHistoryId/discoveryReason/requeueCount/lastRequeuedAt)、
-- v4 的重排水位/claim 欄(lastRequeueEventId/claimToken/claimExpiresAt/claimStage)、
-- v5 的 scanConsumedFloor(Codex 18 輪 §七)都是 gmailIngestionLedger 的欄位,隨下方
-- DROP TABLE 一併移除,無需額外語句。
